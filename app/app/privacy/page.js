    ...
    return (<div className="min-h-screen bg-black text-white">
      ...
      <footer className="px-6 py-8 border-t border-white/10">
        <div className="max-w-3xl mx-auto flex items-center justify-between text-white/30 text-xs">
          <link_1.default href="/" className="hover:text-white/50">← Back to LocalBeacon.ai</link_1.default>
          <link_1.default href="/terms" className="hover:text-white/50">Terms of Service</link_1.default>
        </div>
      </footer>
    </div>);
}
