...
function PATCH(req_1, _a) {
    return __awaiter(this, arguments, void 0, function (req, _b) {
        var userId, id, body, status, supabase, _c, data, error;
            ...
            switch (_d.label) {
                ...
                case 3:
                    ...
                    if (!status || !['draft', 'ready', 'posted'].includes(status)) {
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Invalid status' }, { status: 400 })];
                    }
                ...
                case 4:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, server_2.NextResponse.json({ error: 'Failed to update post' }, { status: 500 })];
                    }
