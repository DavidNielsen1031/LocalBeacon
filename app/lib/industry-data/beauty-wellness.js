...
exports.beautyWellness = void 0;
exports.beautyWellness = {
    'hair-salons': {
        slug: 'hair-salons',
        name: 'Hair Salon',
        plural: 'Hair Salons',
        headline: 'Fill Every Chair, Every Hour',
        subheadline: 'Stylists are booked solid on Saturdays but empty on Tuesdays. LocalBeacon keeps your appointment book balanced all week long.',
        description: 'LocalBeacon helps hair salons attract new clients through Google Business optimization, AI-powered local search visibility, and automated review management so every stylist stays booked.',
        painPoints: [
            {
                icon: '\uD83D\uDCC9',
        ...
        faqs: [
            {
                ...
                answer: 'Yes. LocalBeacon publishes targeted Google Posts promoting midweek specials and last-minute availability, making your salon visible to people searching right now\u2014not just on weekends.',
            },
            {
                question: 'How does this work if I have multiple stylists with different specialties?',
                answer: 'LocalBeacon creates content that highlights your salon\u2019s full range of services\u2014color correction, extensions, curly cuts, bridal\u2014so you attract the right clients for every stylist on your team.',
            },
            {
                question: 'Will this help me compete with chain salons like Supercuts?',
                answer: 'Absolutely. Chain salons dominate on price, but local search favors relevance and reviews. LocalBeacon helps you rank higher by showcasing your expertise, portfolio, and client satisfaction\u2014the things chains cannot replicate.',
            },
            {
                question: 'I already post on Instagram. Why do I need this?',
                answer: 'Instagram builds brand awareness, but 76% of people who search "hair salon near me" book from the Google Maps results. LocalBeacon makes sure your salon shows up there with fresh content, strong reviews, and accurate information.',
            },
            {
                question: 'How do reviews affect my salon\u2019s visibility?',
                answer: 'Google prioritizes businesses with recent, high-rated reviews. LocalBeacon automates review requests after appointments and helps you respond quickly, which signals to Google that your salon is active and trusted.',
            },
            {
                question: 'Can I promote specific services like keratin treatments or balayage?',
                answer: 'Yes. LocalBeacon lets you create Google Posts and city pages focused on high-margin services, so when someone searches "balayage near me" or "keratin treatment [city]," your salon appears.',
            },
        ],
    },
    barbershops: {
        ...
        subheadline: 'Your regulars know you are the best. LocalBeacon makes sure everyone else on the block does too\u2014especially the new residents and younger crowd searching on their phones.',
        description: 'LocalBeacon helps barbershops dominate local search, attract walk-in traffic from nearby neighborhoods, and build an online reputation that matches the loyalty you earn in the chair.',
        painPoints: [
            {
                icon: '\uD83C\uDFD8\uFE0F',
        ...
        faqs: [
            {
                ...
                answer: 'More than ever. Even walk-in customers check Google first\u2014they look at your rating, photos, and hours before deciding to come in. If your profile is sparse or outdated, they walk to the next shop.',
            },
            {
                question: 'How does LocalBeacon help me attract a younger crowd?',
                answer: 'Younger clients discover barbershops through Google Maps and AI search, not word of mouth. LocalBeacon keeps your profile active with fresh content and strong reviews, which is exactly how the under-30 crowd decides where to get a cut.',
            },
            {
                question: 'Can I show that I specialize in certain styles like fades or beard work?',
                answer: 'Yes. LocalBeacon optimizes your profile and creates content around your specialties, so when someone searches "best fade barbershop near me" or "beard trim [city]," you show up.',
            },
            {
                question: 'I have a loyal client base already. Why do I need more marketing?',
                answer: 'Loyal clients move, age out, or change routines. A healthy barbershop needs a steady stream of new clients to replace natural attrition. LocalBeacon ensures that pipeline never dries up.',
            },
            {
                question: 'Will this work for a shop with no appointment system?',
                answer: 'Absolutely. LocalBeacon focuses on driving foot traffic and walk-ins by increasing your visibility in local search. No booking software required\u2014just more people walking through your door.',
            },
        ],
    },
    spas: {
        ...
        subheadline: 'High-ticket spa services demand trust before the first visit. LocalBeacon builds the online presence that converts searchers into booked appointments and gift card buyers.',
        description: 'LocalBeacon helps day spas and wellness spas attract high-value clients through Google optimization, seasonal promotion automation, and reputation management that conveys luxury and trust.',
        painPoints: [
            {
                icon: '\uD83C\uDF81',
        ...
        faqs: [
            {
                ...
                answer: 'Yes. By strengthening your Google Business presence, you shift discovery to a platform where you have more control and pay nothing for visibility. Many spas cut their Yelp spend by 50% or more within six months.',
            },
            {
                question: 'How do you handle the seasonal nature of spa services?',
                answer: 'LocalBeacon automatically schedules Google Posts around peak periods\u2014holiday gift cards, Valentine\u2019s couples packages, summer skincare\u2014so your promotions go live exactly when search demand spikes.',
            },
            {
                question: 'Will this help attract corporate wellness clients?',
                answer: 'Absolutely. City pages targeting business districts and office parks, combined with content about group bookings and corporate packages, help you capture the corporate wellness market in your area.',
            },
            {
                question: 'How does review management work for a luxury brand?',
                answer: 'LocalBeacon crafts thoughtful, on-brand responses to every review. Negative experiences get flagged immediately so you can resolve them before they damage your reputation. The tone always matches your luxury positioning.',
            },
            {
                question: 'Can I promote specific treatments like HydraFacials or hot stone massage?',
                answer: 'Yes. LocalBeacon creates targeted content around your signature services, so searches for specific treatments in your area lead directly to your spa.',
            },
            {
                question: 'I have multiple locations. Can LocalBeacon manage all of them?',
                answer: 'Yes. Our Solo and Agency plans support multiple locations, each with their own optimized Google profile, city pages, and review management\u2014all managed from a single dashboard.',
            },
        ],
    },
    'nail-salons': {
        ...
        subheadline: 'There are four nail salons within two miles of you. LocalBeacon makes yours the one people choose when they search "nail salon near me."',
        description: 'LocalBeacon helps nail salons rise above the intense local competition with Google Business optimization, automated review collection, and local search visibility that drives walk-in traffic.',
        painPoints: [
            {
                icon: '\uD83C\uDFEA',
        ...
        faqs: [
            {
                ...
                answer: 'That is exactly the problem LocalBeacon solves. When multiple salons cluster together, the one with the freshest Google content, highest review count, and best rating wins. LocalBeacon automates all three.',
            },
            {
                question: 'How do I handle negative reviews about hygiene?',
                answer: 'LocalBeacon flags negative reviews instantly so you can respond professionally and quickly. More importantly, it floods your profile with positive reviews so one complaint does not define your salon.',
            },
            {
                question: 'Can I promote specific services like dip powder or nail art?',
                answer: 'Yes. LocalBeacon creates targeted Google Posts and city page content around your specialties, so when someone searches "dip powder nails near me" or "nail art [city]," your salon ranks.',
            },
            {
                question: 'Most of my clients are walk-ins. How does online marketing help?',
                answer: 'Walk-in clients are not random\u2014most check Google Maps on their phone before walking in. They look at your rating, photos, and recent reviews. LocalBeacon makes sure what they see convinces them to choose you.',
            },
            {
                question: 'Will this help me attract higher-spending clients?',
                answer: 'Yes. City pages targeting upscale neighborhoods and content promoting premium services like gel extensions and nail art attract clients who spend more per visit and rebook more frequently.',
            },
        ],
    },
    'med-spas': {
        ...
        subheadline: 'Nobody injects Botox on impulse. Your future clients are researching providers for weeks. LocalBeacon makes sure your med spa earns their trust at every touchpoint.',
        description: 'LocalBeacon helps med spas build the authoritative online presence that high-ticket aesthetic clients demand\u2014Google visibility, trust signals, and local search dominance for Botox, fillers, and advanced treatments.',
        painPoints: [
            {
                icon: '\uD83D\uDD0D',
        ...
        faqs: [
            {
                ...
                answer: 'Yes. Our content avoids restricted claims, uses appropriate disclaimers, and focuses on provider credentials and patient education\u2014the trust signals that convert without crossing compliance lines.',
            },
            {
                question: 'How does this help me compete with med spas running heavy Google Ads?',
                answer: 'Google Ads are expensive and temporary. LocalBeacon builds your organic visibility and Google Business presence\u2014which generates leads for free, permanently. Most med spas see a 50%+ drop in paid ad dependence within six months.',
            },
            {
                question: 'Can I highlight specific providers and their credentials?',
                answer: 'Absolutely. LocalBeacon creates content that showcases your injectors\u2019 and practitioners\u2019 training, certifications, and experience\u2014the exact information patients research before choosing a provider.',
            },
            {
                question: 'How do you handle before-and-after content for treatments?',
                answer: 'LocalBeacon focuses on educational content and provider expertise rather than before-and-after imagery, keeping your marketing effective while staying within platform and regulatory guidelines.',
            },
            {
                question: 'Will this help with consultations for high-ticket treatments like CoolSculpting?',
                answer: 'Yes. City pages and Google Posts targeting specific treatments drive consultation bookings. Clients searching for "CoolSculpting [city]" or "body contouring near me" find your practice with the credibility to convert.',
            },
            {
                question: 'I already have a strong Instagram following. Why do I need Google visibility?',
                answer: 'Instagram builds awareness, but high-ticket decisions happen on Google. Patients searching for "best med spa near me" are ready to book\u2014and they are checking your Google reviews and profile, not your Instagram grid.',
            },
            {
                question: 'How quickly will I see results?',
                answer: 'Most med spas see measurable increases in Google profile views within 30 days and new consultation bookings within 60-90 days. The ROI compounds over time as your review count and content library grow.',
            },
        ],
    },
    'tanning-salons': {
        ...
        subheadline: 'Tanning demand swings wildly with the calendar. LocalBeacon smooths out the seasonal roller coaster by capturing demand when it spikes and building membership revenue when it dips.',
        description: 'LocalBeacon helps tanning salons capture seasonal demand surges, promote spray tan services, and build year-round membership revenue through Google Business optimization and local search visibility.',
        painPoints: [
            {
                icon: '\uD83C\uDF26\uFE0F',
        ...
        faqs: [
            {
                ...
                answer: 'Yes. LocalBeacon creates dedicated content and city pages targeting spray tan searches, which is one of the fastest-growing segments. This helps you capture health-conscious clients who would otherwise skip your salon entirely.',
            },
            {
                question: 'How does LocalBeacon handle seasonal demand swings?',
                answer: 'Automated Google Posts are timed to seasonal search trends\u2014prom prep, wedding season, holiday parties, winter tanning\u2014so your salon is visible exactly when demand spikes in your area.',
            },
            {
                question: 'Will this help reduce membership cancellations?',
                answer: 'Indirectly, yes. By keeping your salon visible in local search year-round, members are constantly reminded of your presence. Consistent Google activity also attracts new members to replace any natural churn.',
            },
            {
                question: 'I offer multiple tanning levels and packages. Can LocalBeacon promote each one?',
                answer: 'Absolutely. Google Posts and city pages can highlight your full range\u2014from basic UV beds to premium stand-ups to custom spray tans\u2014targeting different search queries for each service level.',
            },
            {
                question: 'How do I compete with new tanning salons opening nearby?',
                answer: 'New competitors start with zero reviews and no search history. LocalBeacon helps you build an insurmountable lead in reviews, content, and search visibility that new entrants cannot match quickly.',
            },
        ],
    },
