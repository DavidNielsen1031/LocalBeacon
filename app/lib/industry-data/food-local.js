...
exports.foodLocal = {
    restaurants: {
        ...
        subheadline: "Third-party delivery apps take 30% of every order. LocalBeacon drives direct traffic to your restaurant — customers who walk in, sit down, and come back next week.",
        description: "AI-powered local marketing for restaurants. Automated Google Business Profile posts, city-specific landing pages, review management, and AI search optimization for dine-in, takeout, catering, and direct delivery orders.",
        painPoints: [
            {
                icon: "💸",
        ...
        faqs: [
            {
                ...
                answer: "We keep your Google Business Profile active with weekly posts about specials, events, and menu updates. Combined with city-specific landing pages and professional review management, this drives more diners to find you on Google and order directly — bypassing third-party delivery apps and their commissions.",
            },
            {
                question: "Can LocalBeacon help reduce our reliance on DoorDash and Uber Eats?",
                answer: "Yes. By improving your organic Google visibility, more customers discover your restaurant directly. They call to order, visit your website, or walk in — all without a 15-30% platform commission eating into your margins.",
            },
            {
                question: "How do you handle negative reviews?",
                answer: "LocalBeacon responds to negative reviews promptly and professionally, acknowledging the concern and inviting the guest to return. This shows future diners that you take feedback seriously and often leads to the reviewer updating their rating.",
            },
            {
                question: "Can I promote different things at different times — lunch specials, happy hour, weekend brunch?",
                answer: "Absolutely. LocalBeacon creates time-relevant content — lunch deals posted mid-morning, happy hour promotions on Wednesday afternoons, and brunch highlights on Thursday and Friday. Your posts reach potential diners when they're deciding where to go.",
            },
            {
                question: "We have multiple locations — does this work for restaurant groups?",
                answer: "Yes. Our Agency plan supports unlimited locations, each with its own Google profile, city pages, and tailored content. Perfect for restaurant groups that want consistent marketing across every location.",
            },
            {
                question: "Do I need to update the content myself?",
                answer: "No. After initial setup where you provide your menu, specials, and style preferences, LocalBeacon generates all content automatically. You can review and approve posts if you want, or let them publish on autopilot.",
            },
        ],
    },
    catering: {
        ...
        subheadline: "Corporate lunch orders and wedding receptions don't happen by accident — event planners research extensively online. LocalBeacon makes sure your catering company is the one they find, review, and call.",
        description: "AI-powered local marketing for catering companies. Automated Google Business Profile posts, city-specific landing pages, review management, and AI search optimization for corporate catering, wedding catering, private events, and meal delivery services.",
        painPoints: [
            {
                icon: "🏢",
        ...
        faqs: [
            {
                ...
                answer: "We build your Google presence with weekly posts timed to event planning cycles, create landing pages for every city in your service area, and manage your reviews professionally. This puts you in front of event planners and office managers when they're actively searching for a caterer.",
            },
            {
                question: "Can I target corporate and social events separately?",
                answer: "Yes. LocalBeacon creates distinct content for corporate catering (meetings, conferences, holiday parties) and social events (weddings, birthday parties, graduations) — each with messaging that resonates with that specific audience.",
            },
            {
                question: "How do you handle seasonal fluctuations in catering demand?",
                answer: "We promote different services throughout the year: wedding tastings in winter, corporate lunch programs in spring, summer event packages, and holiday party catering in fall. Off-season content promotes meal prep, weekly delivery, and smaller private dinners.",
            },
            {
                question: "We compete with ezCater and other platforms — can LocalBeacon help?",
                answer: "Absolutely. Those platforms take significant commissions on every order. LocalBeacon drives direct inquiries through organic search — clients who call you directly, negotiate terms with you, and build a relationship that leads to repeat business.",
            },
            {
                question: "How important are Google reviews for a catering company?",
                answer: "Extremely. Catering is a high-trust, high-stakes service — nobody wants to risk bad food at their wedding or corporate event. A strong Google review profile with recent, detailed, responded-to reviews is often the deciding factor between you and a competitor.",
            },
            {
                question: "We serve a large metro area — can we rank in multiple cities?",
                answer: "Yes. Our Solo plan supports up to 3 service areas, and the Agency plan covers unlimited cities. We create dedicated landing pages for each area so you rank locally in every market your kitchen can reach.",
            },
        ],
    },
    bakeries: {
        ...
        subheadline: "Your croissants are perfect and your custom cakes are works of art — but new customers can't taste your baking through a screen. LocalBeacon makes sure they find you, read your rave reviews, and walk through your door.",
        description: "AI-powered local marketing for bakeries. Automated Google Business Profile posts, city-specific landing pages, review management, and AI search optimization for custom cakes, daily pastries, wedding cakes, and specialty baked goods.",
        painPoints: [
            {
                icon: "🎂",
        ...
        faqs: [
            {
                ...
                answer: "We keep your Google Business Profile active with posts about daily specials, seasonal offerings, and custom cake availability. Combined with neighborhood landing pages and professional review responses, this drives more foot traffic and custom orders — especially from new customers who discover you through Google.",
            },
            {
                question: "Can LocalBeacon promote custom cake and wedding cake services?",
                answer: "Yes. Custom and wedding cakes are typically a bakery's highest-margin items. We create dedicated content targeting searches like \"custom birthday cake near me\" and \"wedding cake baker in [city]\" to drive these valuable consultations.",
            },
            {
                question: "We're a small bakery with one location — is this worth it?",
                answer: "Absolutely. Our Free plan is built for single-location businesses. Even a few extra walk-in customers per week can significantly impact a bakery's daily revenue, and one additional custom cake order easily covers the cost of our Solo plan.",
            },
            {
                question: "How do you handle our early morning hours and limited availability?",
                answer: "LocalBeacon ensures your Google listing always shows accurate hours, and our posts can highlight early-morning availability, pre-order options, and \"until sold out\" items. We help set customer expectations so they arrive when you're ready for them.",
            },
            {
                question: "We post a lot on Instagram — why do we need Google marketing too?",
                answer: "Instagram is great for followers who already know you, but Google captures new customers actively searching for a bakery right now. These are the highest-intent customers — they're hungry, nearby, and ready to buy. LocalBeacon makes sure they find you.",
            },
            {
                question: "Can LocalBeacon promote seasonal and holiday items?",
                answer: "Yes. We follow the bakery calendar: Valentine's Day treats, Easter pastries, graduation cakes, fall pumpkin everything, Thanksgiving pies, and holiday cookie boxes. Each seasonal item gets promoted at the right time to capture pre-orders and walk-in demand.",
            },
        ],
    },
    "local-delivery": {
        ...
        subheadline: "Local businesses and residents need fast, reliable delivery from someone who knows the area — not a faceless national carrier. LocalBeacon helps you become the delivery service your community trusts by name.",
        description: "AI-powered local marketing for local delivery services. Automated Google Business Profile posts, city-specific landing pages, review management, and AI search optimization for same-day delivery, restaurant delivery, pharmacy delivery, and local courier services.",
        painPoints: [
            {
                icon: "📦",
        ...
        faqs: [
            {
                ...
                answer: "We help you market the things national carriers can't offer: same-day flexibility, personal service, local knowledge, and community relationships. By ranking you in local search results for every city you cover, we connect you with customers who specifically want a local option.",
            },
            {
                question: "Can LocalBeacon promote our restaurant delivery partnerships?",
                answer: "Yes. We create content highlighting your restaurant partners, delivery menus, and ordering options. This builds your brand as the local delivery service that restaurants trust — driving orders from both the restaurants' customers and yours.",
            },
            {
                question: "How do you communicate our delivery zones to potential customers?",
                answer: "We create dedicated landing pages for every city and neighborhood in your delivery area. When someone searches \"delivery service in [their city],\" they find a page specifically confirming you deliver there — eliminating guesswork.",
            },
            {
                question: "We also do pharmacy and medical supply delivery — can you promote that?",
                answer: "Absolutely. Pharmacy delivery, medical supply delivery, and grocery delivery each get their own content stream. These are often high-trust, recurring services that command premium pricing — exactly the kind of business LocalBeacon helps you attract.",
            },
            {
                question: "How important are reviews for a delivery service?",
                answer: "Critical. Customers need to trust that their package, food, or prescription will arrive safely and on time. Strong, recent reviews with professional responses build that trust before a customer ever places their first order with you.",
            },
            {
                question: "We're a small operation with just a few drivers — is this affordable?",
                answer: "Our Free plan covers one delivery zone with 5 Google posts per month. The Solo plan at $49/month expands to 3 zones with unlimited posts. Most delivery services find that a few new regular customers per month easily covers the investment.",
            },
            {
                question: "Can LocalBeacon help us expand into new delivery areas?",
                answer: "Yes. When you add a new delivery zone, we create landing pages and targeted content for that area immediately. This lets you test demand in a new market before committing drivers and resources — using search volume and inquiries as your proof of concept.",
            },
        ],
    },
    'pizza-shops': {
