...
exports.homeServices = {
    plumbers: {
        ...
        subheadline: "LocalBeacon keeps your plumbing business visible on Google, AI search, and local directories — so homeowners find you first when the pipes burst.",
        description: "AI-powered local marketing for plumbing companies. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for plumbers.",
        painPoints: [
            {
                icon: "📞",
        ...
        faqs: [
            {
                ...
                answer: "LocalBeacon automates the three things Google rewards most: fresh content (weekly posts), local relevance (city-specific pages), and reputation signals (review responses). Plumbing companies using LocalBeacon typically see 2-3× more calls within 90 days.",
            },
            {
                question: "Do I need to write any content myself?",
                answer: "No. LocalBeacon's AI generates all content — Google posts, service area pages, and review responses — based on your business details. You just review and approve.",
            },
            {
                question: "Can LocalBeacon handle multiple plumbing service areas?",
                answer: "Yes. LocalBeacon creates dedicated, optimized pages for every city and neighborhood you serve. Most plumbing clients cover 10-20+ service areas.",
            },
            {
                question: "How is this different from hiring an SEO agency?",
                answer: "SEO agencies charge $1,500-5,000/month and take months to show results. LocalBeacon starts at $49/month, deploys immediately, and handles the ongoing content that agencies often neglect after the initial setup.",
            },
            {
                question: "What if I already have a website?",
                answer: "LocalBeacon works alongside your existing website. We optimize your Google Business Profile, create supplementary local pages, and ensure your business is structured for AI search — without changing your current site.",
            },
        ],
    },
    hvac: {
        ...
        subheadline: "LocalBeacon keeps your HVAC business visible year-round — so you're not scrambling for leads when the weather changes.",
        description: "AI-powered local marketing for HVAC companies. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for heating and cooling businesses.",
        painPoints: [
            {
                icon: "🌡️",
        ...
        faqs: [
            {
                ...
                answer: "LocalBeacon posts seasonal maintenance reminders, indoor air quality tips, and tune-up offers to your Google listing year-round. This keeps your profile active and drives maintenance calls even in shoulder seasons.",
            },
            {
                question: "Can LocalBeacon help me rank in new service areas?",
                answer: "Yes. We create dedicated landing pages for every city, suburb, and neighborhood you want to target — optimized for \"HVAC near me\" searches in each location.",
            },
            {
                question: "What does AI search optimization mean for HVAC?",
                answer: "When homeowners ask ChatGPT, Google AI, or voice assistants for HVAC recommendations, those systems pull from structured data. LocalBeacon ensures your business has the right schema markup, FAQ content, and structured information to be recommended.",
            },
            {
                question: "How long does it take to see results?",
                answer: "Most HVAC clients see increased Google Business Profile views within 2-4 weeks. Call volume typically increases within 60-90 days as local pages index and content builds authority.",
            },
            {
                question: "Do I need to create any content?",
                answer: "No. Our AI generates all posts, pages, and review responses based on your service details. You just review, approve, and watch the calls come in.",
            },
        ],
    },
    electricians: {
        ...
        subheadline: "LocalBeacon makes your electrical business the first one homeowners find — on Google, AI search, and everywhere local customers look.",
        description: "AI-powered local marketing for electrical contractors. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for electricians.",
        painPoints: [
            {
                icon: "⚡",
        ...
        faqs: [
            {
                ...
                answer: "We increase your Google visibility for residential searches — panel upgrades, outlet installs, EV charger installation, and emergency calls. Weekly posts, local pages, and review responses drive consistent residential leads.",
            },
            {
                question: "Can LocalBeacon help me break into new service areas?",
                answer: "Yes. We create optimized landing pages for every city and neighborhood you want to serve. As you expand your territory, we expand your local presence to match.",
            },
            {
                question: "What kind of content does LocalBeacon create for electricians?",
                answer: "Home electrical safety tips, seasonal maintenance reminders (storm prep, holiday lighting safety), EV charger guides, smart home wiring content, and local community updates. All tailored to build trust and drive calls.",
            },
            {
                question: "Is this worth it if I already get referrals?",
                answer: "Referrals are great but unpredictable. LocalBeacon builds a consistent pipeline of new customers who find you online — complementing your referral business and reducing dependence on any single source.",
            },
            {
                question: "How quickly does LocalBeacon start working?",
                answer: "Your Google Business Profile posts start going live within the first week. Local pages typically start ranking within 2-4 weeks. Most electricians see measurable lead increases within 60 days.",
            },
        ],
    },
    roofers: {
        ...
        subheadline: "LocalBeacon keeps your roofing company visible on Google and AI search — so homeowners call you first after the storm.",
        description: "AI-powered local marketing for roofing companies. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for roofers.",
        painPoints: [
            {
                icon: "⛈️",
        ...
        faqs: [
            {
                ...
                answer: "We increase your visibility on Google through weekly posts, city-specific landing pages, and review management. Roofing clients typically see 2-3× more estimate requests within the first quarter.",
            },
            {
                question: "Can LocalBeacon help after a major storm?",
                answer: "Yes. When storms hit your area, your existing local visibility and content authority mean homeowners find you first — not the storm chasers who show up and disappear. Your established presence builds trust.",
            },
            {
                question: "How does this compare to buying leads from HomeAdvisor?",
                answer: "Lead services charge $50-100+ per lead with no exclusivity. LocalBeacon builds your own organic presence at $49/month — leads come directly to you with no per-lead fees and no sharing with competitors.",
            },
            {
                question: "What content does LocalBeacon create for roofers?",
                answer: "Seasonal maintenance tips, storm prep guides, roofing material comparisons, and local community content. Plus dedicated pages for each service (repairs, replacements, inspections) in every city you cover.",
            },
            {
                question: "Do I need any technical skills?",
                answer: "None. LocalBeacon handles everything — content creation, Google posting, review responses, and local page optimization. You just review and approve what we generate.",
            },
        ],
    },
    painters: {
        ...
        subheadline: "LocalBeacon keeps your painting business front and center on Google and AI search — so homeowners request quotes from you instead of scrolling past.",
        description: "AI-powered local marketing for painting companies. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for house painters.",
        painPoints: [
            {
                icon: "🎨",
        ...
        faqs: [
            {
                ...
                answer: "LocalBeacon keeps your Google Business Profile active with weekly painting tips, seasonal content, and professional review responses. Combined with city-specific landing pages, you show up when homeowners search for painters in your area — not just during peak season.",
            },
            {
                question: "Can LocalBeacon help me book interior work during winter?",
                answer: "Yes. We post content about interior painting, cabinet refinishing, wallpaper removal, and holiday prep — keeping your profile visible and driving indoor project inquiries through the slow months.",
            },
            {
                question: "How do I stand out from cheaper painting companies?",
                answer: "LocalBeacon builds your reputation through consistent review responses, educational content about prep work and paint quality, and a strong local presence. Homeowners who find you through organic search are looking for quality, not the cheapest bid.",
            },
            {
                question: "What kind of content does LocalBeacon create for painters?",
                answer: "Color trend updates, exterior prep checklists, interior vs. exterior paint guides, deck and fence staining tips, and seasonal reminders. All written specifically for your market and posted to your Google listing automatically.",
            },
            {
                question: "Do I need to provide photos or content?",
                answer: "No. LocalBeacon generates all written content based on your business details. If you want to include before-and-after photos, you can — but it's not required. The AI handles everything from posts to review responses.",
            },
            {
                question: "How long before I see more estimate requests?",
                answer: "Google posts go live within the first week. City pages typically start ranking in 2-4 weeks. Most painting companies see a noticeable uptick in estimate requests within 60-90 days.",
            },
        ],
    },
    "cleaning-services": {
        ...
        subheadline: "LocalBeacon keeps your cleaning business visible on Google and AI search — so new clients find you before they find a competitor with fewer reviews.",
        description: "AI-powered local marketing for residential and commercial cleaning companies. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for cleaning services.",
        painPoints: [
            {
                icon: "🔄",
        ...
        faqs: [
            {
                ...
                answer: "We keep your Google Business Profile active with weekly content, build city-specific landing pages for every area you serve, and draft professional review responses. Cleaning companies using LocalBeacon typically see 2-3× more booking inquiries within 90 days.",
            },
            {
                question: "Can LocalBeacon help me get both residential and commercial clients?",
                answer: "Yes. We create separate landing pages optimized for residential cleaning searches (\"house cleaning near me\") and commercial searches (\"office cleaning service\"). Different audiences, different pages, both driving leads.",
            },
            {
                question: "How important are reviews for cleaning services?",
                answer: "Critical. Cleaning is a trust-based service — people are letting you into their homes. LocalBeacon helps you respond to every review professionally, building the social proof that converts browsers into bookers.",
            },
            {
                question: "What content does LocalBeacon post for cleaning companies?",
                answer: "Seasonal cleaning tips, allergy-reduction guides, move-in/move-out checklists, eco-friendly cleaning advice, and local community updates. All tailored to your services and posted automatically.",
            },
            {
                question: "Will this help me fill cancellation gaps?",
                answer: "Yes. A consistent online presence generates a steady flow of new inquiries. When a recurring client cancels, you already have interested prospects ready to fill that slot instead of scrambling to find replacements.",
            },
            {
                question: "Do I need any marketing experience?",
                answer: "None at all. LocalBeacon handles content creation, Google posting, review management, and local page optimization. You focus on cleaning — we focus on keeping your schedule full.",
            },
        ],
    },
    "pest-control": {
        ...
        subheadline: "LocalBeacon keeps your pest control business visible on Google and AI search — so panicked homeowners find you instantly, not your competitor down the road.",
        description: "AI-powered local marketing for pest control companies. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for exterminators and pest management professionals.",
        painPoints: [
            {
                icon: "🐜",
        ...
        faqs: [
            {
                ...
                answer: "We post seasonal pest alerts, prevention tips, and treatment information to your Google listing year-round. Combined with city-specific landing pages and review management, pest control clients typically see 2-3× more calls within the first quarter.",
            },
            {
                question: "Can LocalBeacon help me sell more recurring treatment plans?",
                answer: "Yes. Our automated content educates homeowners on the benefits of quarterly pest prevention — not just reactive treatments. This shifts the conversation from \"kill this bug\" to \"protect my home year-round,\" driving recurring revenue.",
            },
            {
                question: "What kind of content does LocalBeacon create for pest control?",
                answer: "Seasonal pest alerts (termite season, rodent season, mosquito season), prevention tips, DIY vs. professional treatment guides, and local pest activity updates. All tailored to your region and the pests your customers actually deal with.",
            },
            {
                question: "How does this help with emergency pest calls?",
                answer: "Emergency searches like \"exterminator near me now\" favor businesses with active Google profiles, strong reviews, and structured data. LocalBeacon ensures you check all three boxes so you show up first when someone needs help urgently.",
            },
            {
                question: "Do I need to write anything or manage content?",
                answer: "No. LocalBeacon's AI generates all posts, pages, and review responses based on your service details and local pest patterns. You review and approve — that's it.",
            },
            {
                question: "How long until I see more calls?",
                answer: "Google posts start within the first week. City pages begin ranking in 2-4 weeks. Most pest control companies see a measurable increase in calls within 60 days, with a significant jump during their next peak pest season.",
            },
        ],
    },
    movers: {
        ...
        subheadline: "LocalBeacon makes your moving company the one homeowners trust and call first — on Google, AI search, and local directories where moving decisions start.",
        description: "AI-powered local marketing for moving companies. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for local and long-distance movers.",
        painPoints: [
            {
                icon: "📦",
        ...
        faqs: [
            {
                ...
                answer: "We increase your visibility on Google through weekly content, city-specific and route-specific landing pages, and professional review management. Moving companies using LocalBeacon typically see 2-3× more quote requests within the first quarter.",
            },
            {
                question: "Can LocalBeacon help me get off-season bookings?",
                answer: "Yes. We post content about corporate relocations, downsizing, senior moves, and winter moving benefits that drive inquiries year-round — not just during the summer rush.",
            },
            {
                question: "How does LocalBeacon help overcome the trust problem in moving?",
                answer: "Consistent online presence, strong review management, and professional content signal legitimacy. When a homeowner sees weekly posts, dozens of responded-to reviews, and detailed service pages, they know you're not a fly-by-night operation.",
            },
            {
                question: "What kind of content does LocalBeacon create for movers?",
                answer: "Packing tips, moving checklists, cost estimation guides, apartment vs. house moving advice, long-distance moving preparation, and seasonal content. All designed to capture homeowners during the research and planning phase.",
            },
            {
                question: "Can you create pages for specific moving routes?",
                answer: "Yes. Beyond city pages, we create route-specific pages like \"Moving from [City A] to [City B]\" that capture long-distance and intercity moving searches — a high-intent keyword most competitors ignore.",
            },
            {
                question: "How quickly will I see results?",
                answer: "Posts go live within the first week. Landing pages start ranking in 2-4 weeks. Most moving companies see measurable quote increases within 60-90 days, with the biggest impact during their next peak moving season.",
            },
        ],
    },
    locksmiths: {
        ...
        subheadline: "LocalBeacon builds the trusted online presence that separates your legitimate locksmith business from the fake listings and bait-and-switch operators flooding Google.",
        description: "AI-powered local marketing for locksmiths. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for legitimate locksmith businesses.",
        painPoints: [
            {
                icon: "🔒",
        ...
        faqs: [
            {
                ...
                answer: "Consistent content, real reviews with professional responses, and verified local pages signal to both Google and customers that you're legitimate. Over time, your authentic presence outranks and outperforms fake listings that have no real engagement.",
            },
            {
                question: "Can LocalBeacon help me get more emergency lockout calls?",
                answer: "Yes. We optimize your profile for emergency keywords, ensure your hours show 24/7 availability, and build the local authority that puts you at the top of urgent \"locksmith near me\" searches — when customers don't have time to scroll.",
            },
            {
                question: "What content does LocalBeacon post for locksmiths?",
                answer: "Home security tips, smart lock reviews, rekeying vs. replacing guides, car lockout prevention advice, and seasonal security reminders. Content that positions you as a security expert, not just someone who picks locks.",
            },
            {
                question: "How does LocalBeacon help with pricing objections?",
                answer: "Transparent content about locksmith pricing, educational posts about what fair pricing looks like, and a strong review presence all reduce the suspicion customers feel. When they see your professional online presence, they're less likely to haggle.",
            },
            {
                question: "Will this work if I also do commercial locksmith work?",
                answer: "Absolutely. We create separate pages for residential lockouts, commercial access control, automotive locksmith services, and safe installation — each optimized for the specific searches those customers use.",
            },
            {
                question: "How fast can LocalBeacon start working for my locksmith business?",
                answer: "Posts go live within the first week. Because locksmith searches are high-intent and often emergency-driven, even small improvements in visibility translate to calls quickly. Most clients see measurable results within 30-45 days.",
            },
        ],
    },
    handymen: {
        ...
        subheadline: "LocalBeacon keeps your handyman business booked with the small-to-medium projects homeowners need done — on Google, AI search, and local directories.",
        description: "AI-powered local marketing for handyman services. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for general handymen and home repair professionals.",
        painPoints: [
            {
                icon: "🔧",
        ...
        faqs: [
            {
                ...
                answer: "We create content and landing pages for every service you offer — not just \"handyman.\" By targeting specific searches like \"deck repair near me\" and \"TV mounting in [city],\" you capture the homeowners who need exactly what you do.",
            },
            {
                question: "Can LocalBeacon help me fill gaps in my schedule?",
                answer: "Yes. A consistent online presence generates steady inquiries throughout the week. When a job cancels or finishes early, you have a queue of interested homeowners instead of an empty afternoon.",
            },
            {
                question: "I do a lot of different things — can LocalBeacon handle that?",
                answer: "That's actually your superpower. We create separate content and pages for each service — plumbing repairs, drywall patching, deck maintenance, furniture assembly, TV mounting, and more. The broader your skills, the more keywords we can target.",
            },
            {
                question: "What if I don't have a contractor's license?",
                answer: "LocalBeacon focuses on the handyman services that typically don't require licensure — small repairs, installations, and maintenance. We tailor your content to the services you legally offer in your state.",
            },
            {
                question: "How does this help me compete with larger home service companies?",
                answer: "Homeowners often prefer a local handyman over a big company for small jobs. LocalBeacon amplifies that advantage by making you the visible, well-reviewed local option with neighborhood-specific pages that national companies can't match.",
            },
            {
                question: "How soon will I see more calls?",
                answer: "Posts start going live within the first week. Because handyman searches are high-frequency and local, most clients see new inquiries within 3-4 weeks, with a strong pipeline building within 60 days.",
            },
        ],
    },
    "appliance-repair": {
        ...
        subheadline: "LocalBeacon makes your appliance repair business the first one homeowners find when the fridge stops cooling or the washer won't spin.",
        description: "AI-powered local marketing for appliance repair companies. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for appliance repair technicians.",
        painPoints: [
            {
                icon: "🧊",
        ...
        faqs: [
            {
                ...
                answer: "We target both general appliance repair searches and brand-specific queries that most competitors miss. Combined with weekly maintenance content and professional review responses, our clients typically see 2-3× more calls within 90 days.",
            },
            {
                question: "Can LocalBeacon create pages for specific appliance brands I service?",
                answer: "Yes. We create dedicated pages for every brand you work on — Samsung, LG, Whirlpool, GE, Maytag, Bosch, and more — combined with every city you serve. \"GE Refrigerator Repair in [City]\" is exactly the kind of search that drives high-intent calls.",
            },
            {
                question: "How does this help me compete with manufacturer-authorized repair networks?",
                answer: "Many homeowners are out of warranty, have older appliances, or want a second opinion. LocalBeacon positions you as the experienced, local alternative — faster response times, transparent pricing, and the expertise to handle any brand.",
            },
            {
                question: "What content does LocalBeacon create for appliance repair?",
                answer: "Appliance maintenance tips, troubleshooting guides (\"Why is my dryer not heating?\"), seasonal prep reminders, energy efficiency advice, and repair vs. replace decision guides. Content that answers the questions homeowners are already searching for.",
            },
            {
                question: "Do I need to provide technical information?",
                answer: "Just tell us which brands and appliances you service. Our AI generates technically accurate, homeowner-friendly content based on your specialties. You review and approve — no writing required.",
            },
            {
                question: "How fast does LocalBeacon start generating leads for appliance repair?",
                answer: "Appliance repair is one of the fastest categories to see results because searches are urgent and high-intent. Posts go live within the first week, and most clients see new calls within 2-3 weeks as city and brand pages start indexing.",
            },
        ],
    },
    "garage-door": {
        ...
        subheadline: "LocalBeacon keeps your garage door business visible on Google and AI search — so homeowners call you first when the door won't open, the spring snaps, or they want an upgrade.",
        description: "AI-powered local marketing for garage door companies. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for garage door installation and repair businesses.",
        painPoints: [
            {
                icon: "⚙️",
        ...
        faqs: [
            {
                ...
                answer: "We increase your Google visibility for both emergency repairs (broken springs, stuck doors) and planned projects (new installations, opener upgrades). Weekly content, local pages, and review management typically drive 2-3× more calls within 90 days.",
            },
            {
                question: "Can LocalBeacon help me get more installation jobs, not just repairs?",
                answer: "Yes. We create content about garage door styles, insulation benefits, smart opener features, and curb appeal upgrades that capture homeowners researching new garage doors — not just the ones with an emergency.",
            },
            {
                question: "What kind of content does LocalBeacon create for garage door companies?",
                answer: "Spring maintenance tips, opener troubleshooting guides, insulated vs. non-insulated door comparisons, smart garage door features, weatherstripping advice, and seasonal safety checks. All posted automatically to your Google listing.",
            },
            {
                question: "How does this help with emergency garage door calls?",
                answer: "Emergency searches are won by the most visible, most trusted result. LocalBeacon builds your profile authority through consistent posting and review management so when someone's spring snaps at 7 AM, you're the first call.",
            },
            {
                question: "Do I need to provide any content or technical information?",
                answer: "Just your service details — what you repair, what you install, brands you carry, and areas you cover. Our AI generates all content, posts, and review responses. You just review and approve.",
            },
            {
                question: "How soon will I see results?",
                answer: "Garage door searches are high-intent — people need the service now or soon. Posts go live within the first week, and most companies see new calls within 3-4 weeks as local pages index and content builds visibility.",
            },
        ],
    },
    fencing: {
        ...
        subheadline: "LocalBeacon keeps your fencing company visible on Google and AI search — so homeowners call you first when they need a new fence, not the cheapest quote on Thumbtack.",
        description: "AI-powered local marketing for fencing companies. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for fence installation and repair businesses.",
        painPoints: [
            {
                icon: "🌧️",
        ...
        faqs: [
            {
                ...
                answer: "We target the searches homeowners make when planning a fence — material comparisons, cost guides, permit questions, and local contractor searches. Weekly content, city pages, and review management typically drive 2-3× more quote requests within the first quarter.",
            },
            {
                question: "Can LocalBeacon help me book jobs during the off-season?",
                answer: "Yes. We post content about spring planning, early-bird booking incentives, material selection guides, and virtual consultation availability — converting winter researchers into confirmed spring installations before your competitors wake up.",
            },
            {
                question: "What kind of content does LocalBeacon create for fencing companies?",
                answer: "Wood vs. vinyl comparisons, privacy fence height guides, HOA-friendly fencing options, pool fence safety requirements, property line and setback explainers, and seasonal maintenance tips. All tailored to your local market and regulations.",
            },
            {
                question: "How does this help with the \"three quotes\" problem?",
                answer: "Homeowners always get multiple quotes, but they give the job to the company they trust most. A strong online presence with consistent content and professional reviews means you're often the first call — and the one they compare everyone else against.",
            },
            {
                question: "Can LocalBeacon help me rank for specific fence types?",
                answer: "Yes. We create content and pages for privacy fences, picket fences, chain-link, vinyl, wood, aluminum, pool fencing, and commercial fencing — each optimized for the specific searches homeowners use for that material or style.",
            },
            {
                question: "How quickly will I see results?",
                answer: "Posts go live within the first week. City and material-specific pages typically start ranking in 2-4 weeks. Most fencing companies see measurable quote increases within 60-90 days, especially as their next peak season approaches.",
            },
        ],
    },
    'emergency-plumbers': {
