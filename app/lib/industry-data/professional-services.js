...
exports.professionalServices = {
    accountants: {
        ...
        subheadline: 'LocalBeacon keeps your accounting practice visible year-round — so businesses and individuals find you for advisory, bookkeeping, and planning, not just April filings.',
        description: 'AI-powered local marketing for accounting firms and CPAs. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for accountants.',
        painPoints: [
            {
                icon: '📅',
        ...
        faqs: [
            {
                ...
                answer: 'Most accounting firms go quiet on marketing after April. LocalBeacon automatically posts advisory content, bookkeeping tips, and planning reminders to your Google Business Profile year-round. This consistent visibility drives inquiries for payroll, QuickBooks help, business formation, and estate planning — not just tax prep.',
            },
            {
                question: 'Will this help me compete with TurboTax and H&R Block?',
                answer: 'Yes. National chains win on brand awareness, but local searches are different. When someone searches "CPA near me" or "accountant in [city]," LocalBeacon ensures your practice appears with strong reviews, fresh content, and city-specific pages — signals Google rewards over generic national listings.',
            },
            {
                question: 'Are review responses appropriate for accounting clients?',
                answer: 'Absolutely. Our AI drafts responses that thank clients without referencing any specific financial details, tax situations, or account information. Every response is professional, warm, and privacy-conscious.',
            },
            {
                question: 'Can LocalBeacon handle multiple office locations?',
                answer: 'Yes. Our Solo plan supports up to 3 locations and our Agency plan covers unlimited offices. Each location gets its own Google Business Profile management, local pages, and review responses.',
            },
            {
                question: 'How is this different from hiring a marketing agency?',
                answer: 'Marketing agencies specializing in accounting firms charge $2,000-6,000/month and often lock you into annual contracts. LocalBeacon starts at $49/month, deploys the same day, and handles the ongoing content and review management that agencies typically neglect after the initial setup.',
            },
            {
                question: 'Do I need to write blog posts or create content?',
                answer: 'No. LocalBeacon generates all content — Google posts, city pages, and review responses — based on the services you offer and the areas you serve. You simply review and approve.',
            },
        ],
    },
    'financial-advisors': {
        ...
        subheadline: 'LocalBeacon positions your advisory practice as the trusted local option — so prospects choose your expertise over Betterment, Wealthfront, and the robo-advisors.',
        description: 'AI-powered local marketing for financial advisors and wealth management firms. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for RIAs and financial planners.',
        painPoints: [
            {
                icon: '🤖',
        ...
        faqs: [
            {
                ...
                answer: 'LocalBeacon generates educational, informational content — market commentary, planning tips, life-stage guides — without performance claims, guarantees, or testimonial language. We recommend your compliance team review posts before publishing, and our one-click approval workflow makes that easy.',
            },
            {
                question: 'How does this help me compete with robo-advisors?',
                answer: 'Robo-advisors dominate paid search with massive budgets. But local, organic search is different. When someone searches "financial advisor in [city]," Google prioritizes local businesses with strong profiles, reviews, and fresh content. LocalBeacon builds exactly that.',
            },
            {
                question: 'What kind of content does LocalBeacon create for financial advisors?',
                answer: 'Retirement planning tips, Social Security optimization guides, market commentary, tax-efficient investing education, estate planning reminders, and life-event financial guides (new baby, divorce, inheritance). All educational, never promotional.',
            },
            {
                question: 'Can I use this if I serve a niche like business owners or doctors?',
                answer: 'Yes. LocalBeacon tailors content to your specific clientele. If you specialize in physician financial planning or business succession, your Google posts and local pages reflect that specialization.',
            },
            {
                question: 'How does this work with my existing website and CRM?',
                answer: 'LocalBeacon works alongside your existing website and marketing. We focus on Google Business Profile optimization, local landing pages, and AI search readiness — complementing your site, not replacing it.',
            },
            {
                question: 'How long before I see results?',
                answer: 'Google Business Profile engagement typically increases within 2-3 weeks. Most financial advisors see an uptick in discovery meeting requests within 60-90 days as local pages index and content authority builds.',
            },
        ],
    },
    'insurance-agents': {
        ...
        subheadline: 'LocalBeacon keeps your insurance agency top of local search — so clients call you first instead of comparing rates on Geico.com or Progressive.com.',
        description: 'AI-powered local marketing for independent insurance agents and agencies. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for insurance professionals.',
        painPoints: [
            {
                icon: '💻',
        ...
        faqs: [
            {
                ...
                answer: 'Online carriers win on convenience, but local agents win on trust and expertise. LocalBeacon amplifies your local advantage by keeping your Google presence active with educational content, strong reviews, and city-specific pages that position you as the go-to local expert.',
            },
            {
                question: 'Can LocalBeacon help with client retention, not just acquisition?',
                answer: 'Yes. Consistent Google posts and review engagement keep your agency visible to existing clients. When renewal season hits, they see your name regularly and are less likely to shop around.',
            },
            {
                question: 'What kind of content does LocalBeacon create for insurance agents?',
                answer: 'Seasonal coverage reminders, claims preparation guides, policy bundling tips, life-event insurance guides (new home, new baby, teen driver), and community safety content. All designed to educate and build trust.',
            },
            {
                question: 'Does this work for independent agents with multiple carriers?',
                answer: 'Absolutely. LocalBeacon highlights your ability to shop multiple carriers on behalf of clients — a key advantage over captive agents and direct-to-consumer carriers. Your content emphasizes choice, not a single brand.',
            },
            {
                question: 'How quickly will I see new leads?',
                answer: 'Google profile engagement typically increases within 2-3 weeks. Most insurance agents see measurable increases in quote requests within 45-60 days as local pages index and content builds visibility.',
            },
            {
                question: 'Is this worth it if I already have a good referral network?',
                answer: 'Referrals are valuable but unpredictable. LocalBeacon adds a consistent inbound channel that complements referrals — so your pipeline stays full even during slow referral months.',
            },
        ],
    },
    'real-estate-agents': {
        ...
        subheadline: 'LocalBeacon establishes your hyperlocal authority on Google and AI search — so buyers and sellers find you before they find a Zillow Premier Agent.',
        description: 'AI-powered local marketing for real estate agents and brokerages. Automated Google Business Profile posts, neighborhood-specific landing pages, review responses, and AI search optimization built for realtors.',
        painPoints: [
            {
                icon: '🏠',
        ...
        faqs: [
            {
                ...
                answer: 'Sellers research agents online before calling. LocalBeacon ensures your Google presence is strong — fresh market content, active review responses, and neighborhood-specific pages that prove you know the area. When a seller searches "best realtor in [neighborhood]," you show up with credibility.',
            },
            {
                question: 'Can this replace Zillow Premier Agent?',
                answer: 'Many agents use LocalBeacon to reduce their Zillow dependency. Instead of paying $500-2,000/month for shared leads, LocalBeacon builds your own organic pipeline at a fraction of the cost. The leads come directly to you, unshared.',
            },
            {
                question: 'What kind of content does LocalBeacon create for realtors?',
                answer: 'Monthly market updates, mortgage rate commentary, neighborhood spotlights, seasonal buying and selling guides, open house announcements, and community event highlights. Content that positions you as the hyperlocal expert.',
            },
            {
                question: 'Does this work for teams and brokerages?',
                answer: 'Yes. Our Agency plan supports unlimited locations and agents. Each agent or office can have their own Google Business Profile management, local pages, and review responses.',
            },
            {
                question: 'How does the AI search optimization work for real estate?',
                answer: 'AI assistants like ChatGPT and Google AI pull from structured data when recommending local professionals. LocalBeacon adds schema markup, FAQ content, and neighborhood authority signals that help these AI systems recommend you.',
            },
            {
                question: 'I already post on social media. Do I need this?',
                answer: 'Social media is great for brand awareness, but it does not help you rank on Google. When someone actively searches for an agent — the highest-intent moment — Google results matter most. LocalBeacon ensures you show up there.',
            },
            {
                question: 'How fast will I see results?',
                answer: 'Google profile views typically increase within 2 weeks. Most agents see a measurable increase in direct calls and listing inquiries within 60-90 days.',
            },
        ],
    },
    notaries: {
        ...
        subheadline: 'LocalBeacon keeps your notary services visible on Google and AI search — so clients find you for closings, apostilles, and mobile appointments before they try an online service.',
        description: 'AI-powered local marketing for notaries and mobile notary services. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for notary professionals.',
        painPoints: [
            {
                icon: '📱',
        ...
        faqs: [
            {
                ...
                answer: 'Most people search "notary near me" when they need one urgently. LocalBeacon ensures your Google Business Profile is optimized with fresh content, strong reviews, and city-specific pages so you appear first in those time-sensitive searches.',
            },
            {
                question: 'Can LocalBeacon help me get direct clients instead of signing service jobs?',
                answer: 'Yes. Signing services pay $75-150 per appointment and take a significant cut. Direct clients from Google typically pay your full mobile notary fee ($150-300+). LocalBeacon builds the visibility that drives direct bookings.',
            },
            {
                question: 'How does this help me compete with Remote Online Notarization?',
                answer: 'Many transactions still legally require in-person notarization — certain real estate closings, immigration documents, and court filings. LocalBeacon positions you as the convenient, mobile, in-person option for clients who need physical presence.',
            },
            {
                question: 'What content does LocalBeacon create for notaries?',
                answer: 'Document preparation guides, "when do you need a notary" educational posts, real estate closing tips, apostille process explanations, and mobile notary availability updates. Content that answers the exact questions people have when they need a notary.',
            },
            {
                question: 'Is this worth it for a side-gig notary?',
                answer: 'Especially so. At $49/month, even two or three additional direct clients per month more than pays for LocalBeacon. Many side-gig notaries use LocalBeacon to transition to full-time mobile notary work.',
            },
        ],
    },
    'tax-preparation': {
