...
exports.petServices = {
    'pet-grooming': {
        ...
        subheadline: 'LocalBeacon keeps your grooming salon visible on Google and AI search — so pet parents find you for regular appointments, not just when Fido is matted beyond recognition.',
        description: 'AI-powered local marketing for pet grooming salons and mobile groomers. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for pet grooming businesses.',
        painPoints: [
            {
                icon: '🐾',
        ...
        faqs: [
            {
                ...
                answer: 'LocalBeacon increases your visibility on Google through weekly posts, city-specific pages, and active review management. When pet parents search "dog groomer near me," you appear with strong reviews and fresh content. Most groomers see a measurable increase in new bookings within 45 days.',
            },
            {
                question: 'Can this help me build recurring clients, not just one-time visits?',
                answer: 'Yes. LocalBeacon posts seasonal grooming reminders, coat care tips, and rebooking nudges to your Google profile. When a pet parent sees your post about spring shedding season, they remember it is time to book. Consistent visibility drives recurring appointments.',
            },
            {
                question: 'Does this work for mobile grooming businesses?',
                answer: 'Absolutely. Mobile groomers benefit even more from local page optimization. LocalBeacon creates pages for every neighborhood in your service area — "Mobile Dog Grooming in [Neighborhood]" — so you rank everywhere your van travels.',
            },
            {
                question: 'What kind of content does LocalBeacon create for pet groomers?',
                answer: 'Breed-specific grooming tips, seasonal coat care guides, holiday grooming specials, before-and-after styling highlights, and pet safety content. All designed to showcase your expertise and keep pet parents engaged.',
            },
            {
                question: 'How does AI search matter for pet grooming?',
                answer: 'More pet parents are asking AI assistants for recommendations — "best groomer for my Poodle near me" or "cat groomer that handles anxious cats." LocalBeacon structures your data so AI systems can recommend you based on your specific services, breed expertise, and review strength.',
            },
            {
                question: 'I mostly get clients from word of mouth. Do I need this?',
                answer: 'Word of mouth is powerful but plateaus. LocalBeacon adds a digital channel that works 24/7 — even when your happy clients are not actively recommending you. Think of it as word of mouth that never sleeps.',
            },
        ],
    },
    'dog-walking': {
        ...
        subheadline: 'LocalBeacon makes you the trusted neighborhood dog walker on Google and AI search — so pet parents choose you over Rover, Wag, and random Craigslist posts.',
        description: 'AI-powered local marketing for dog walkers and pet sitting services. Automated Google Business Profile posts, neighborhood-specific service pages, review responses, and AI search optimization built for dog walking businesses.',
        painPoints: [
            {
                icon: '📲',
        ...
        faqs: [
            {
                ...
                answer: 'LocalBeacon builds your own Google presence — profile optimization, local pages, and review management — so pet parents find you directly. No 20-40% platform fee. Clients book with you, pay you, and build a relationship with you, not an app.',
            },
            {
                question: 'Can LocalBeacon help me expand to new neighborhoods?',
                answer: 'Yes. As you take on new areas, LocalBeacon creates optimized pages for each neighborhood. "Dog Walker in [Neighborhood]" pages rank for local searches and attract clients in your expanding service area.',
            },
            {
                question: 'What kind of content does LocalBeacon create for dog walkers?',
                answer: 'Seasonal pet safety tips, dog exercise advice, neighborhood walking route highlights, weather-related dog care (hot pavement warnings, cold weather precautions), and availability updates. All content builds trust and demonstrates your expertise.',
            },
            {
                question: 'Is this worth it when I am just starting out?',
                answer: 'Especially when starting out. New dog walkers struggle to get their first reviews and visibility. LocalBeacon accelerates that process — fresh content and active profile management signal to Google (and pet parents) that you are professional and established.',
            },
            {
                question: 'How does this help with trust and safety concerns?',
                answer: 'A strong Google profile with consistent reviews, professional responses, and active posting signals legitimacy. Pet parents are far more likely to hand over their house keys to a walker with a well-managed online presence than someone with no digital footprint.',
            },
            {
                question: 'Do I need a business website for this to work?',
                answer: 'No. LocalBeacon optimizes your Google Business Profile and creates local landing pages — many dog walkers operate entirely through Google and direct bookings without a separate website. Your Google profile becomes your digital storefront.',
            },
            {
                question: 'How fast will I get new clients?',
                answer: 'Google profile engagement typically increases within 1-2 weeks. Most dog walkers see new booking requests within 30-45 days, especially in underserved neighborhoods where competition is low.',
            },
        ],
    },
    'pet-boarding': {
        ...
        subheadline: 'LocalBeacon keeps your boarding facility visible on Google and AI search — so anxious pet parents choose your facility over impersonal apps when vacation season arrives.',
        description: 'AI-powered local marketing for pet boarding facilities, kennels, and doggy daycares. Automated Google Business Profile posts, city-specific landing pages, review responses, and AI search optimization built for pet boarding businesses.',
        painPoints: [
            {
                icon: '🎄',
        ...
        faqs: [
            {
                ...
                answer: 'LocalBeacon promotes daycare packages, training add-ons, and off-peak specials through weekly Google posts. When pet parents see your active profile with fresh content about playgroups, enrichment activities, and availability, they think of you for weekday daycare — not just holiday boarding.',
            },
            {
                question: 'Can LocalBeacon help anxious pet parents feel comfortable booking?',
                answer: 'Yes. Consistent Google posts about your facility, safety protocols, and staff create transparency. Active review responses that address concerns and highlight positive experiences reassure anxious pet parents that their fur baby is in good hands.',
            },
            {
                question: 'How does this help us compete with Rover and pet-sitting apps?',
                answer: 'LocalBeacon highlights the advantages home sitters cannot match — supervised socialization, veterinary partnerships, climate-controlled environments, webcam access, and trained staff. Your Google content tells the story of professional, safe pet care.',
            },
            {
                question: 'What kind of content does LocalBeacon create for boarding facilities?',
                answer: 'Holiday booking deadline reminders, daycare program highlights, facility upgrade announcements, pet safety tips, enrichment activity spotlights, and seasonal content (summer pool play, winter indoor activities). All designed to showcase your facility and fill reservations.',
            },
            {
                question: 'Does this work for facilities that also offer grooming or training?',
                answer: 'Absolutely. LocalBeacon promotes all your services — boarding, daycare, grooming, and training — through targeted content and local pages. Cross-promoting services to existing boarding clients drives additional revenue.',
            },
            {
                question: 'How quickly will I see more reservations?',
                answer: 'Google profile engagement typically increases within 2 weeks. Most boarding facilities see a measurable uptick in reservation requests and facility tour bookings within 45-60 days.',
            },
            {
                question: 'Can this help us book holiday stays earlier?',
                answer: 'Yes. LocalBeacon posts holiday booking reminders weeks in advance — "Thanksgiving boarding is filling up" and "Book your Christmas stay now" posts that drive early reservations and reduce last-minute scrambles.',
            },
        ],
    },
    'mobile-pet-grooming': {
