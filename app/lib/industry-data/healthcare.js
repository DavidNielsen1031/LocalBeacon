...
exports.healthcare = {
    dental: {
        ...
        subheadline: "LocalBeacon handles your practice's local marketing — so you can focus on patients, not posting to Google.",
        description: "AI-powered local marketing for dental practices. Automated Google Business Profile posts, city-specific practice pages, review responses, and AI search optimization built for dentists.",
        painPoints: [
            {
                icon: "🦷",
        ...
        faqs: [
            {
                ...
                answer: "LocalBeacon increases your Google Business Profile visibility through weekly posts, local landing pages, and review management. Most dental clients see 15-30 new patient inquiries per month from improved local visibility.",
            },
            {
                question: "Are the review responses HIPAA-compliant?",
                answer: "Yes. Our AI is trained to respond to reviews without referencing specific treatments, diagnoses, or patient health information. Responses thank patients and address concerns in general terms.",
            },
            {
                question: "Can this work for multi-location dental practices?",
                answer: "Absolutely. Our Agency plan supports unlimited locations, each with their own Google Business Profile management, local pages, and review responses.",
            },
            {
                question: "What kind of content does LocalBeacon create for dentists?",
                answer: "Weekly Google posts about oral health tips, seasonal reminders, practice updates, and community involvement. Plus dedicated landing pages for each service (cleanings, whitening, implants) in each city you serve.",
            },
            {
                question: "How is this different from a dental marketing agency?",
                answer: "Dental marketing agencies charge $2,000-8,000/month and often lock you into long contracts. LocalBeacon starts at $49/month, works immediately, and you can cancel anytime.",
            },
        ],
    },
    chiropractors: {
        ...
        subheadline: "LocalBeacon puts your practice in front of people actively searching for drug-free pain relief — not skeptics you have to convince.",
        description: "AI-powered local marketing for chiropractic practices. Automated Google Business Profile posts, city-specific landing pages, review management, and AI search optimization built for chiropractors.",
        painPoints: [
            {
                icon: "🩻",
        ...
        faqs: [
            {
                ...
                answer: "We increase your local visibility through automated Google Business Profile posts, city-specific landing pages, and professional review management. Most chiropractic clients see a significant uptick in new patient calls within 60-90 days.",
            },
            {
                question: "Can LocalBeacon help overcome the skepticism around chiropractic care?",
                answer: "Yes. Our AI creates educational content that focuses on evidence-based benefits, patient wellness tips, and real-world use cases. Consistent, professional content builds credibility with people who are curious but haven't committed yet.",
            },
            {
                question: "Do you handle review responses for chiropractors?",
                answer: "Absolutely. Every review gets a HIPAA-mindful response that thanks the patient without referencing specific conditions or treatments. This builds trust with future patients who are reading reviews before booking.",
            },
            {
                question: "How does this compare to paying for chiropractic leads from a directory?",
                answer: "Lead services charge $30-80 per lead and those patients are often shopping multiple providers. LocalBeacon builds your organic visibility so patients find and choose you directly — no bidding wars, no shared leads.",
            },
            {
                question: "What kind of content does LocalBeacon post for chiropractic practices?",
                answer: "Posts about wellness tips, posture correction, injury prevention, sports recovery, and seasonal health topics. The content is tailored to chiropractic — not generic health advice.",
            },
            {
                question: "Can this help my practice rank above physical therapy clinics?",
                answer: "LocalBeacon optimizes for chiropractic-specific keywords and search intent. While we can't guarantee rankings, practices using LocalBeacon consistently outperform competitors who aren't actively managing their local presence.",
            },
        ],
    },
    optometrists: {
        ...
        subheadline: "LocalBeacon keeps your optometry practice visible locally — so patients choose your chair over online retailers and big-box optical stores.",
        description: "AI-powered local marketing for optometry practices. Automated Google Business Profile posts, city-specific practice pages, review management, and AI search optimization built for optometrists.",
        painPoints: [
            {
                icon: "👓",
        ...
        faqs: [
            {
                ...
                answer: "We make sure your practice dominates local search results for eye exams, contact lenses, and optical services. When patients find a trusted local optometrist, they're far more likely to buy glasses and contacts from your office rather than ordering online.",
            },
            {
                question: "What kind of content does LocalBeacon create for eye care practices?",
                answer: "Weekly posts about eye health topics — screen time and blue light, children's vision development, contact lens care, seasonal allergies — plus insurance reminders and practice news. All tailored to optometry, not generic healthcare content.",
            },
            {
                question: "Can LocalBeacon help attract families with children?",
                answer: "Yes. We create targeted content and landing pages around pediatric eye exams, back-to-school vision screenings, and children's eyewear. Parents searching for kids' eye care in your area will find your practice.",
            },
            {
                question: "Are review responses safe for optometry practices?",
                answer: "All review responses are HIPAA-mindful. Our AI never references prescriptions, exam results, or vision conditions. Responses are warm, professional, and focused on the patient experience.",
            },
            {
                question: "Does this work for optometrists who also sell frames and lenses?",
                answer: "Absolutely. We highlight your full-service offering — exams, fittings, and optical products — in your Google posts and landing pages. This helps patients see you as a one-stop shop rather than just an exam provider.",
            },
            {
                question: "How does LocalBeacon handle insurance-related content?",
                answer: "We can create posts reminding patients to use their vision benefits before year-end and build landing pages that mention accepted insurance plans. This drives searches from patients specifically looking for in-network providers.",
            },
        ],
    },
    veterinarians: {
        ...
        subheadline: "LocalBeacon keeps your veterinary practice visible to pet owners in your area — so they choose you for wellness care, not just emergencies.",
        description: "AI-powered local marketing for veterinary practices. Automated Google Business Profile posts, city-specific clinic pages, review management, and AI search optimization built for veterinarians.",
        painPoints: [
            {
                icon: "🐾",
        ...
        faqs: [
            {
                ...
                answer: "We boost your local visibility through weekly Google posts about pet health, landing pages targeting nearby communities, and review management. Pet parents searching for a vet in your area find a practice that looks active, caring, and well-reviewed.",
            },
            {
                question: "Can LocalBeacon help us compete with corporate vet chains like Banfield?",
                answer: "Yes. Corporate chains rely on brand recognition, but local search is where independent practices win. LocalBeacon ensures your Google profile is consistently active and your practice ranks for local vet searches in every neighborhood you serve.",
            },
            {
                question: "What kind of content does LocalBeacon post for vets?",
                answer: "Pet wellness tips, seasonal safety reminders (heat stroke, holiday hazards, fireworks anxiety), vaccination schedules, dental health awareness, and new pet parent guides. All content is written specifically for veterinary practices — not repurposed human healthcare content.",
            },
            {
                question: "How do you handle review responses for veterinary clinics?",
                answer: "Every review receives a compassionate, professional response. We never reference specific pets, conditions, or treatments. Positive reviews get genuine gratitude; negative reviews get empathetic, solution-oriented replies that show future clients you care.",
            },
            {
                question: "Does this work for specialty or emergency-only veterinary practices?",
                answer: "Absolutely. We tailor content and landing pages to your specialty — whether that's emergency care, exotic pets, orthopedic surgery, or general wellness. Your content matches the services you actually offer.",
            },
            {
                question: "Can LocalBeacon help promote our wellness plans or membership programs?",
                answer: "Yes. We can feature your wellness plans in Google posts and landing pages, helping pet owners discover the value of preventive care packages at your practice.",
            },
        ],
    },
    "physical-therapists": {
        ...
        subheadline: "LocalBeacon helps physical therapy clinics build local visibility — so you get direct patient searches on top of your physician referrals.",
        description: "AI-powered local marketing for physical therapy clinics. Automated Google Business Profile posts, city-specific clinic pages, review management, and AI search optimization built for physical therapists.",
        painPoints: [
            {
                icon: "🏋️",
        ...
        faqs: [
            {
                ...
                answer: "We build your direct-to-patient visibility through Google Business Profile posts, local landing pages, and review management. In most states, patients can self-refer for physical therapy — LocalBeacon makes sure they find your clinic when they search.",
            },
            {
                question: "Can this help in states that require physician referrals for PT?",
                answer: "Yes. Even in referral-required states, patients often research and choose their own PT clinic after getting a referral. Being the most visible, best-reviewed clinic in your area means physicians' patients request your clinic by name.",
            },
            {
                question: "What kind of content does LocalBeacon create for physical therapy?",
                answer: "Weekly posts about injury prevention, post-surgery recovery tips, stretching routines, sports performance, and condition-specific education (back pain, shoulder injuries, knee rehab). All written for PT — not generic health content.",
            },
            {
                question: "How do review responses work for PT practices?",
                answer: "Our AI drafts HIPAA-mindful responses that acknowledge the patient's experience without mentioning specific injuries, surgeries, or treatment protocols. Positive outcomes are celebrated generally; concerns are addressed with empathy and professionalism.",
            },
            {
                question: "Does LocalBeacon help with workers' comp or auto accident patients?",
                answer: "We create landing pages and content that target searches like 'physical therapy for car accident' or 'workers comp PT near me' — helping you attract these higher-value patient segments organically.",
            },
            {
                question: "How is this different from just asking our front desk to post on Google?",
                answer: "Front desk staff are busy with patients, insurance calls, and scheduling. Posts get forgotten. LocalBeacon runs automatically — every week, your Google profile gets fresh, professional content without anyone on your team lifting a finger.",
            },
        ],
    },
    dermatologists: {
        ...
        subheadline: "LocalBeacon builds your local visibility so patients searching for skin care, screenings, and cosmetic treatments find your practice — not a med spa.",
        description: "AI-powered local marketing for dermatology practices. Automated Google Business Profile posts, city-specific practice pages, review management, and AI search optimization built for dermatologists.",
        painPoints: [
            {
                icon: "⏳",
        ...
        faqs: [
            {
                ...
                answer: "We increase your Google Business Profile visibility with weekly posts, local landing pages for every service and city, and professional review management. Most dermatology clients see significant increases in appointment requests within 60-90 days.",
            },
            {
                question: "Can LocalBeacon attract both medical and cosmetic dermatology patients?",
                answer: "Yes. We create separate content strategies and landing pages for medical dermatology (skin checks, rashes, eczema) and cosmetic services (Botox, fillers, laser treatments). Your practice appears for both search intents without mixing messaging.",
            },
            {
                question: "How do you handle reviews for dermatology practices?",
                answer: "All review responses are HIPAA-mindful — we never reference specific skin conditions, procedures, or treatment outcomes. Responses are professional, grateful, and designed to build confidence with prospective patients reading reviews.",
            },
            {
                question: "Can this help differentiate us from med spas?",
                answer: "Absolutely. Our content emphasizes your board certification, medical training, and the safety advantages of receiving cosmetic treatments from a dermatologist. Landing pages highlight credentials that med spas simply can't match.",
            },
            {
                question: "What content does LocalBeacon create for dermatologists?",
                answer: "Weekly posts on sun safety, skin cancer awareness months, seasonal skincare adjustments, acne education, anti-aging tips, and practice milestones. Plus dedicated landing pages for specific services like Mohs surgery, phototherapy, and cosmetic injectables.",
            },
            {
                question: "We already have a long waitlist. Why do we need more visibility?",
                answer: "A waitlist means demand exceeds capacity today. LocalBeacon helps you fill new providers' schedules, promote expanded hours, and build a referral pipeline that sustains your practice through growth, staff changes, and seasonal fluctuations.",
            },
        ],
    },
    pediatricians: {
        ...
        subheadline: "LocalBeacon keeps your pediatric practice visible to parents in your community — from pregnancy Googling through the teenage years.",
        description: "AI-powered local marketing for pediatric practices. Automated Google Business Profile posts, city-specific practice pages, review management, and AI search optimization built for pediatricians.",
        painPoints: [
            {
                icon: "👶",
        ...
        faqs: [
            {
                ...
                answer: "We increase your visibility with expecting and new parents through targeted Google posts, local landing pages, and review management. Parents choose pediatricians early — often during pregnancy — so consistent visibility is critical.",
            },
            {
                question: "What kind of content does LocalBeacon create for pediatricians?",
                answer: "Weekly posts about well-child visit schedules, developmental milestones, seasonal illness prevention, back-to-school health tips, and newborn care. Content is written for parents — informative, reassuring, and never alarmist.",
            },
            {
                question: "How do you handle reviews for pediatric practices?",
                answer: "All responses are HIPAA-mindful and especially careful with minors' privacy. We never reference children's names, ages, conditions, or visit details. Responses thank families warmly and address concerns professionally.",
            },
            {
                question: "Can LocalBeacon help address vaccine-related questions?",
                answer: "We create educational content about recommended vaccine schedules and well-child visits that reinforces evidence-based guidance. This positions your practice as a trusted source of information for parents researching online.",
            },
            {
                question: "How does this help us compete with urgent care and retail clinics?",
                answer: "Our content emphasizes the value of a dedicated medical home — continuity of care, developmental monitoring, and a doctor who knows your child's history. Parents who understand this difference are far less likely to switch to retail clinics for routine care.",
            },
            {
                question: "Does this work for pediatric practices with multiple providers?",
                answer: "Yes. Our Agency plan supports practices with multiple providers and locations. Each location gets its own Google Business Profile management, local pages, and tailored content.",
            },
            {
                question: "How quickly will we see results?",
                answer: "Most pediatric practices see increased profile views within 30 days and measurable new patient inquiries within 60-90 days. Practices in competitive suburban markets often see the biggest gains because consistent visibility is rare among pediatricians.",
            },
        ],
    },
    "mental-health-counselors": {
        ...
        subheadline: "LocalBeacon helps your counseling practice show up where people actually search for help — not buried on page 3 behind Psychology Today listings.",
        description: "AI-powered local marketing for mental health counselors and therapists. Automated Google Business Profile posts, city-specific practice pages, review management, and AI search optimization built for counseling practices.",
        painPoints: [
            {
                icon: "🧠",
        ...
        faqs: [
            {
                ...
                answer: "We build your Google Business Profile visibility, create local landing pages, and manage your reviews — so potential clients find your practice directly through Google search and Maps instead of scrolling through directory profiles where you blend in with everyone else.",
            },
            {
                question: "How do you handle review responses for mental health practices?",
                answer: "With the highest level of privacy sensitivity. Our AI never confirms or denies a therapeutic relationship, mentions diagnoses, references session content, or discusses treatment modalities. Responses are warm, professional, and fully HIPAA-mindful.",
            },
            {
                question: "What kind of content does LocalBeacon create for counseling practices?",
                answer: "Weekly posts on stress management, seasonal mental health topics, wellness tips, and destigmatizing messages. Content is written to be approachable and informative — never clinical or triggering. We help normalize seeking help.",
            },
            {
                question: "Can LocalBeacon help if I'm only on certain insurance panels?",
                answer: "Yes. We create landing pages that mention accepted insurance plans and target searches like 'therapist near me that takes Blue Cross.' This helps you attract clients who are specifically looking for in-network providers.",
            },
            {
                question: "How does this help me compete with BetterHelp and other telehealth platforms?",
                answer: "Telehealth platforms compete on convenience and price. LocalBeacon helps you compete on trust, personal connection, and local availability. Many clients prefer in-person therapy — they just need to find a local therapist they feel good about. That's where we help.",
            },
            {
                question: "I'm a solo practitioner. Is this worth it if I only need a few new clients per month?",
                answer: "Absolutely. Solo practitioners often benefit the most because a handful of consistent new clients per month fills your caseload. At $49/month, even one new client covers the cost many times over. And you can pause or cancel anytime.",
            },
            {
                question: "Will the content feel authentic to my practice's approach?",
                answer: "Our AI creates professional, general wellness content that's appropriate for any therapeutic orientation. It's designed to be warm and accessible — not to represent a specific modality. You always have the opportunity to review and adjust.",
            },
        ],
    },
    'cosmetic-dentists': {
