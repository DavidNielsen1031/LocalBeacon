...
exports.fitnessRecreation = void 0;
exports.fitnessRecreation = {
    gyms: {
        slug: 'gyms',
        name: 'Gym',
        plural: 'Gyms',
        headline: 'Keep members walking in, not walking out.',
        subheadline: 'LocalBeacon keeps your gym visible year-round on Google and AI search — so your January rush turns into February retention and your summer slump becomes a signup season.',
        description: 'AI-powered local marketing for gyms and fitness centers. Automated Google Business Profile posts, city-specific landing pages, review responses, and AI search optimization built for independent gyms.',
        painPoints: [
            {
                icon: '📉',
        ...
        faqs: [
            {
                ...
                answer: 'Retention starts with visibility. When members see your gym actively posting challenges, new classes, and community updates on Google, it reinforces their decision to stay. LocalBeacon automates this ongoing engagement without adding to your staff\'s workload.',
            },
            {
                question: 'Can this help my gym compete with Planet Fitness and national chains?',
                answer: 'Yes. Chains win on price, but independent gyms win on community, coaching, and results. LocalBeacon helps you dominate local search with content that highlights what chains cannot offer — personal attention, real coaching, and a genuine community.',
            },
            {
                question: 'What kind of content does LocalBeacon create for gyms?',
                answer: 'Seasonal fitness challenges, new class announcements, training tips, nutrition guidance, member achievement highlights, and community events. Content tailored to your gym\'s specific offerings and personality.',
            },
            {
                question: 'Does this work for specialized gyms like CrossFit or boutique studios?',
                answer: 'Absolutely. LocalBeacon adapts content to your niche — WOD tips for CrossFit boxes, class format spotlights for boutique studios, or powerlifting content for strength gyms. Your Google presence reflects what makes you unique.',
            },
            {
                question: 'How does AI search matter for gyms?',
                answer: 'More people are asking AI assistants "best gym near me" instead of scrolling Google results. LocalBeacon structures your business data so AI systems can recommend you — including your class types, hours, amenities, and review strength.',
            },
            {
                question: 'How quickly will I see new member signups?',
                answer: 'Google profile views typically increase within 2 weeks. Most gyms see a measurable uptick in tour requests and trial signups within 45-60 days.',
            },
        ],
    },
    'personal-trainers': {
        ...
        subheadline: 'LocalBeacon positions you as the go-to trainer in your area — so clients find your expertise on Google and AI search instead of scrolling past another Instagram post.',
        description: 'AI-powered local marketing for personal trainers and fitness coaches. Automated Google Business Profile posts, city-specific service pages, review responses, and AI search optimization built for independent trainers.',
        painPoints: [
            {
                icon: '📱',
        ...
        faqs: [
            {
                ...
                answer: 'Most personal trainers rely on gym floor networking and Instagram. LocalBeacon adds a third, more reliable channel — Google local search. When someone in your area searches for a personal trainer, you show up with strong reviews, fresh content, and city-specific pages.',
            },
            {
                question: 'I already post on Instagram. Why do I need this?',
                answer: 'Instagram builds brand awareness but reaches people who are already following you. Google reaches people actively searching for a trainer right now — the highest-intent prospects. LocalBeacon ensures you show up in those ready-to-buy searches.',
            },
            {
                question: 'Can LocalBeacon help if I train at multiple locations?',
                answer: 'Yes. Whether you train at clients\' homes, multiple gyms, or your own studio, LocalBeacon creates local pages for every area you serve — so you are found wherever your clients are.',
            },
            {
                question: 'What content does LocalBeacon create for trainers?',
                answer: 'Quick workout tips, nutrition advice, exercise form guidance, seasonal fitness content (summer shred, holiday survival guides), and general wellness education. All designed to demonstrate your expertise and drive consultation requests.',
            },
            {
                question: 'How does this compare to paying a gym for leads?',
                answer: 'Gym lead programs charge $200-500/month and you compete with other trainers at the same facility. LocalBeacon builds your own client pipeline for less money — leads come directly to you, exclusively.',
            },
            {
                question: 'Is this worth it if I only have a few open slots?',
                answer: 'Especially then. When your schedule is nearly full, you can be selective about new clients. A steady pipeline lets you choose clients who are the best fit rather than accepting anyone who walks in.',
            },
        ],
    },
    'yoga-studios': {
        ...
        subheadline: 'LocalBeacon brings new students to your mat through Google and AI search — so your community grows organically without you spending hours on marketing.',
        description: 'AI-powered local marketing for yoga studios and meditation centers. Automated Google Business Profile posts, city-specific studio pages, review responses, and AI search optimization built for yoga businesses.',
        painPoints: [
            {
                icon: '📲',
        ...
        faqs: [
            {
                ...
                answer: 'When someone searches "yoga near me" or "beginner yoga classes in [city]," LocalBeacon ensures your studio appears with strong reviews, fresh content, and class variety information. Most studios see a measurable increase in intro class sign-ups within 60 days.',
            },
            {
                question: 'Can this help reduce my ClassPass dependency?',
                answer: 'Yes. ClassPass fills mats at a discount and builds no loyalty. LocalBeacon drives direct Google traffic — students who find you organically, pay full rate, and are more likely to become long-term members.',
            },
            {
                question: 'What kind of content does LocalBeacon create for yoga studios?',
                answer: 'Workshop announcements, new class format launches, teacher spotlights, mindfulness tips, seasonal wellness content (winter restorative series, summer outdoor yoga), and community event highlights. All written in an authentic, wellness-aligned tone.',
            },
            {
                question: 'Does this work for specialized styles like hot yoga, Ashtanga, or Kundalini?',
                answer: 'Absolutely. LocalBeacon tailors content to your specific style and offerings. If you specialize in hot yoga, your Google posts and local pages reflect that — attracting the students who are specifically seeking your style.',
            },
            {
                question: 'Will the AI-generated content feel authentic to my studio\'s voice?',
                answer: 'LocalBeacon generates content based on your studio\'s offerings, style, and values. The tone is warm, community-focused, and wellness-aligned. You review and approve everything before it posts.',
            },
            {
                question: 'How is this different from posting on Instagram?',
                answer: 'Instagram reaches your existing followers. Google reaches people actively searching for a yoga studio right now — the highest-intent prospects. Both matter, but LocalBeacon ensures you win the moment someone decides to try yoga.',
            },
        ],
    },
    'martial-arts': {
        ...
        subheadline: 'LocalBeacon keeps your martial arts school visible on Google and AI search — so parents find your kids programs and adults discover your self-defense classes.',
        description: 'AI-powered local marketing for martial arts schools, dojos, and academies. Automated Google Business Profile posts, city-specific landing pages, review responses, and AI search optimization built for martial arts businesses.',
        painPoints: [
            {
                icon: '👧',
        ...
        faqs: [
            {
                ...
                answer: 'Parents research extensively before enrolling their kids. LocalBeacon ensures your school has a strong Google presence — active posting, great review management, and local landing pages — so when parents search "martial arts for kids near me," your school appears with the credibility they need to book a trial.',
            },
            {
                question: 'Can LocalBeacon promote both kids and adult programs?',
                answer: 'Yes. LocalBeacon creates content for both audiences — kids\' discipline and confidence-building content that appeals to parents, and self-defense, fitness, and competition-focused content that attracts adult students.',
            },
            {
                question: 'What kind of content does LocalBeacon create for martial arts schools?',
                answer: 'Belt testing celebrations, anti-bullying awareness posts, summer camp promotions, tournament announcements, self-defense tips, new class schedule updates, and martial arts philosophy content. All tailored to your specific discipline — karate, taekwondo, BJJ, or mixed martial arts.',
            },
            {
                question: 'Does this work for multiple martial arts styles?',
                answer: 'Absolutely. Whether you teach karate, taekwondo, Brazilian jiu-jitsu, Krav Maga, or multiple disciplines, LocalBeacon tailors your content and local pages to the specific styles you offer.',
            },
            {
                question: 'How does this help with seasonal enrollment?',
                answer: 'Martial arts schools see enrollment spikes in September (back-to-school) and January (resolutions). LocalBeacon promotes trial classes and special offers ahead of these peaks, and maintains visibility during slower months with ongoing content.',
            },
            {
                question: 'How fast will I see new trial class requests?',
                answer: 'Google profile engagement typically increases within 2 weeks. Most martial arts schools see a measurable increase in trial class bookings within 45-60 days as local pages index and content builds authority.',
            },
            {
                question: 'Is this worth it for a small, single-location school?',
                answer: 'Yes — small schools benefit the most. You do not have a marketing department or big ad budget. LocalBeacon gives you the consistent local visibility that larger schools achieve through sheer name recognition. Even our Free plan supports one location.',
            },
        ],
    },
    'crossfit-gyms': {
