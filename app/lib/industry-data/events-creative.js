...
exports.eventsCreative = void 0;
exports.eventsCreative = {
    photographers: {
        slug: "photographers",
        name: "Photography",
        plural: "Photographers",
        headline: "Get booked without begging for referrals.",
        subheadline: "Your portfolio is stunning — but it's buried on Instagram where only your existing followers see it. LocalBeacon puts your photography business in front of people actively searching for a photographer in your area.",
        description: "AI-powered local marketing for photographers. Automated Google Business Profile posts, city-specific service pages, review management, and AI search optimization for wedding, portrait, family, and commercial photography.",
        painPoints: [
            {
                icon: "📱",
        ...
        faqs: [
            {
                ...
                answer: "We build your Google presence with weekly posts, city-specific landing pages, and professional review responses. This puts you in front of people actively searching for a photographer — not just scrolling Instagram. Most photographers see a measurable increase in inquiries within 60-90 days.",
            },
            {
                question: "I'm a wedding photographer — does this work for the wedding industry?",
                answer: "Especially well. Engaged couples research heavily on Google before choosing a photographer. LocalBeacon creates content targeting \"wedding photographer in [city]\" searches and builds the review profile that gives couples confidence to book.",
            },
            {
                question: "Can I promote different types of photography?",
                answer: "Yes. Whether you shoot weddings, portraits, families, newborns, events, or commercial work, LocalBeacon creates separate content for each specialty — so you rank for every type of photography you offer.",
            },
            {
                question: "I already have a strong Instagram presence — why do I need this?",
                answer: "Instagram is great for showcasing your portfolio to followers, but it doesn't help you rank on Google. When someone searches \"photographer near me,\" Google shows local business listings and websites — not Instagram profiles. LocalBeacon fills that gap.",
            },
            {
                question: "What if I work from home and don't have a studio?",
                answer: "Many successful photographers work without a physical studio. LocalBeacon focuses on your service areas rather than a storefront, creating city pages for the locations where you shoot and want to book more work.",
            },
            {
                question: "How much time does this take to manage?",
                answer: "Almost none. LocalBeacon automates Google posts, review responses, and city page creation. After initial setup (about 15 minutes), the platform runs on autopilot. You focus on shooting — we handle the marketing.",
            },
        ],
    },
    "wedding-planners": {
        ...
        subheadline: "Engaged couples Google \"wedding planner near me\" long before they ask friends for referrals. LocalBeacon makes sure your business is the one they find, trust, and call first.",
        description: "AI-powered local marketing for wedding planners and event coordinators. Automated Google Business Profile posts, city-specific landing pages, review management, and AI search optimization for full-service planning, day-of coordination, and destination weddings.",
        painPoints: [
            {
                icon: "📋",
        ...
        faqs: [
            {
                ...
                answer: "We keep your Google Business Profile active with weekly posts, build city-specific landing pages for every venue market you serve, and respond to reviews professionally. This puts you in front of engaged couples when they're actively searching — typically 8-12 months before their wedding.",
            },
            {
                question: "I'm on The Knot and WeddingWire — do I still need this?",
                answer: "Yes. Those platforms are pay-to-play and you're listed alongside every competitor. LocalBeacon builds your own Google presence so couples find you directly — no competing vendor listings on the same page, and no commissions or advertising fees.",
            },
            {
                question: "Can LocalBeacon promote day-of coordination separately from full planning?",
                answer: "Absolutely. We create distinct content for each service you offer — full-service planning, partial planning, day-of coordination, and destination wedding services — each targeted to the right audience.",
            },
            {
                question: "What if I serve multiple cities or destination markets?",
                answer: "That's where LocalBeacon shines. Our Solo and Agency plans let you create landing pages for every city and venue market you serve — whether that's three neighboring towns or wedding destinations across the country.",
            },
            {
                question: "How important are Google reviews for wedding planners?",
                answer: "Critical. 93% of couples read reviews before contacting a wedding planner. A profile with many recent, responded-to reviews dramatically outperforms one with a handful of old, unacknowledged reviews — both in Google rankings and in client trust.",
            },
        ],
    },
    djs: {
        ...
        subheadline: "Your mixes pack dance floors — but that doesn't matter if no one can find you online. LocalBeacon builds the local presence that turns Google searches into gig requests.",
        description: "AI-powered local marketing for DJs and mobile entertainment companies. Automated Google Business Profile posts, city-specific service pages, review management, and AI search optimization for wedding DJs, corporate event DJs, and party entertainment.",
        painPoints: [
            {
                icon: "🎵",
        ...
        faqs: [
            {
                ...
                answer: "We build your Google presence with weekly posts, create landing pages for every city you serve, and manage your reviews professionally. This puts you in front of event hosts actively searching for a DJ — not waiting for a friend-of-a-friend referral.",
            },
            {
                question: "I do weddings, corporate events, and private parties — can I promote all of them?",
                answer: "Yes. LocalBeacon creates separate content for each event type, targeting brides searching for wedding DJs, event planners looking for corporate entertainment, and hosts planning private parties — each with messaging that resonates with that audience.",
            },
            {
                question: "Can LocalBeacon help me compete against Spotify playlists?",
                answer: "Absolutely. We create content that educates potential clients on what a professional DJ brings that a playlist can't — crowd reading, seamless mixing, MC services, professional sound equipment, and the ability to adapt in real time.",
            },
            {
                question: "I'm a solo DJ — is this worth it for a one-person business?",
                answer: "Especially so. Solo DJs can't afford a marketing team, but you still need a strong online presence. Our Free plan gets you started, and the Solo plan at $49/month is far less than what one additional booking per month would earn you.",
            },
            {
                question: "How do reviews help DJs specifically?",
                answer: "DJs are hired based on trust and vibe. Detailed reviews mentioning packed dance floors, great song selection, and professional demeanor do more selling than any website copy. LocalBeacon ensures every review gets a thoughtful response that reinforces those qualities.",
            },
            {
                question: "What about social media — shouldn't I just focus on Instagram and TikTok?",
                answer: "Social media shows what you do, but Google is where people go when they're ready to hire. Most event hosts start with a Google search, check reviews, and visit your website before reaching out. LocalBeacon makes sure that search-to-contact journey works in your favor.",
            },
        ],
    },
    florists: {
        ...
        subheadline: "Local florists are losing orders to 1-800-Flowers and online delivery apps every day. LocalBeacon helps you recapture those customers by making your shop the top result for flower searches in your area.",
        description: "AI-powered local marketing for florists and flower shops. Automated Google Business Profile posts, city-specific landing pages, review management, and AI search optimization for wedding flowers, sympathy arrangements, daily deliveries, and special occasion bouquets.",
        painPoints: [
            {
                icon: "📦",
        ...
        faqs: [
            {
                ...
                answer: "We create hyperlocal content that national chains can't replicate — city-specific landing pages, neighborhood-targeted Google posts, and a strong local review profile. When someone searches for flowers in your area, we help you outrank the 1-800 numbers.",
            },
            {
                question: "Can LocalBeacon promote wedding floral services?",
                answer: "Yes. Wedding florals are often a florist's highest-margin service. We create dedicated content targeting engaged couples searching for wedding florists in your area, with city-specific pages for popular venue locations.",
            },
            {
                question: "What about sympathy and funeral arrangements?",
                answer: "Sympathy arrangements are searched for urgently and locally — exactly the kind of search LocalBeacon excels at capturing. We create content that positions your shop as the compassionate, reliable choice for same-day sympathy deliveries.",
            },
            {
                question: "I do most of my marketing on Instagram — why do I need Google?",
                answer: "Instagram followers already know you. Google captures new customers who don't know you yet but are actively searching for a florist right now. These are high-intent buyers ready to place an order — the most valuable leads for any flower shop.",
            },
            {
                question: "How do you handle seasonal content for florists?",
                answer: "LocalBeacon follows the floral calendar: Valentine's Day, Mother's Day, prom, wedding season, Thanksgiving centerpieces, and holiday arrangements. Content is created and posted in advance of each season to capture early shoppers.",
            },
            {
                question: "Can I promote flower subscriptions and corporate accounts?",
                answer: "Absolutely. Recurring revenue from weekly subscriptions and corporate lobby arrangements is the key to smoothing out seasonal peaks. LocalBeacon creates content specifically targeting businesses and individuals interested in regular flower deliveries.",
            },
            {
                question: "What's the cost for a small flower shop?",
                answer: "LocalBeacon starts free for one location with 5 posts per month. The Solo plan at $49/month adds unlimited posts and up to 3 delivery zone areas. Most flower shops find that one or two additional orders per month more than covers the cost.",
            },
        ],
    },
