...
export function HomepageSeoContent() {
  return (
    ...
    >
      ...
      <p>
        LocalBeacon.ai provides AI-powered local marketing automation for small businesses across the United States.
      ...
      <p>LocalBeacon.ai is an AI-powered local marketing platform that automates Google Business Profile posts, creates city-specific landing pages, drafts review responses, and optimizes your business for AI search engines like ChatGPT and Perplexity. It costs $49 per month — a fraction of what SEO agencies charge.</p>
      ...
      <p>An SEO agency charges $800 to $1,500 per month and you wait weeks to see results. LocalBeacon generates your first content within minutes of signing up for just $49 per month. You get AI-written Google posts, local city pages, and review reply drafts — no contracts, cancel anytime.</p>
